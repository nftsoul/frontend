            ...
            <v-row justify="center">
                <v-col cols="12" lg="6" md="8">
                    ...
                    <v-form ref="form" v-model="valid">
                        ...
                        <FormCustomTextArea v-model="about_team" :rules="[
                          validRules.required,
                          validRules.lengthMax200,
                          validRules.lengthMin3,
                        ]" />
                        ...
                        <v-row>
                            <v-col cols="6" v-for="i in team" :key="i">
                                ...
                                <FormCustomTextField v-model="member.social_link[i]" :rules="[
                                  validRules.required,
                                  validRules.lengthMax200,
                                  validRules.validLink,
                                ]" />
                                <v-col align="center">
                        ...
                        <FormCustomTextField v-model="twitter" :rules="[
                          validRules.required,
                          validRules.lengthMin3,
                          validRules.validLink,
                          validRules.twitterLink,
                        ]" />

                        <label for="">Discord Link</label>
                        <FormCustomTextField v-model="discord" :rules="[
                          validRules.required,
                          validRules.lengthMin3,
                          validRules.validLink,
                          validRules.discordLink,
                        ]" />

                        <label for="">Linkedin Profile</label>
                        <FormCustomTextField v-model="linkedin" :rules="[
                          validRules.required,
                          validRules.lengthMin3,
                          ,
                          validRules.validLink,
                          validRules.linkedinLink,
                        ]" />
                                    ...
                                    <div style="border: 1px solid #fe87ff" class="py-2">
                                        ...
                                        <client-only>
                                            <VueSlickCarousel v-bind="slickSetting" v-if="files.length > 0">
                                                <div class="d-flex flex-wrap" v-for="(item, i) in files" :key="i">
                                                    <div class="flex-item mx-auto mb-2">
    ...
    data() {
        return {
            ...
            validRules: {
                ...
                lengthMax200: (v) =>
                    (v && v.length < 200) || "Should not be more than 200 characters.",
                ...
                twitterLink: (v) =>
                    ...
                    /https?:[0-9]*\/\/(?:www\.)?twitter\.com\/([a-zA-Z0-9_]+)+/.test(v) ||
                    "Not a twitter link",
                discordLink: (v) =>
                    /https?:[0-9]*\/\/(?:www\.)?discord\.com\/([a-zA-Z0-9_]+)+/.test(v) ||
                    "Not a discord link",
                linkedinLink: (v) =>
                    /https?:[0-9]*\/\/(?:www\.)?linkedin\.com\/([a-zA-Z0-9_]+)+/.test(v) ||
                    ...
                    if (finalmem.length > 0) {
                        this.$axios
                            ...
                            .then((res) => {
                                this.$toast
                                    .success(
                                        "Your mint showcase has been created successfully.",
                                        {
                                            iconPack: "mdi",
                                            icon: "mdi-image",
                                            theme: "outline",
                                    ...
                                    .goAway(3000);
                                this.$router.push(
                                    "/profile/" + this.userAddress + "/mint-showcase"
                                );
                                this.saving = false;
                            })
