                            ...
                            <v-card color="transparent" flat max-width="300" height="470" @click="seePremium(item)">
                                <div class="outer-card">
                                    <div class="inner-card">
                                        ...
                                        <v-card class="rounded-pill mt-n6" max-width="150" style="">
                                            <v-list dense class="py-1">
                                                <v-list-item dense class="pa-0">
                                                    ...
                                                    <v-list-item-content>
                                                        <v-list-item-title class="ml-n2">{{item.gallery_id.user_id.slice(0,5)+'....'}}</v-list-item-title>
                                                    </v-list-item-content>
                                                </v-list-item>
                                            </v-list>
                                        </v-card>
                                        ...
                                        <v-row>
                                            <div class="prem-sup-card rounded-lg" v-for="(nft,i) in item.gallery_id.nfts" :key="i">
