                ...
                <v-col cols="12" lg="7">
                    <div class="enclose-border">
                        <v-form v-model="valid" ref="form">
                            ...
                            <v-textarea v-model="name"
                                :rules="[validRules.required, validRules.lengthMin3, validRules.lengthMax50]" id="name"
                                rows="1" dense outlined placeholder="e.g. 'My Best NFT'"></v-textarea>

                            <label for="about" class="text--disabled">Short story about your Gallery</label>
                            <v-textarea v-model="about" :rules="[validRules.required, validRules.lengthMax100]"
                                id="about" rows="3" auto-grow background-color="#030537" dense outlined
                                placeholder="e.g.'The fact that makes this gallery worth watch...'"></v-textarea>
                            ...
                            <v-text-field v-model="price" type="number" v-if="premium"
                                :rules="[validRules.required, validRules.positive, validRules.sollimit]"
                                :hint="getHint()" persistent-hint id="price" filled background-color="#030537" dense
                                outlined placeholder="e.g. '0.01 SOL'"></v-text-field>
                            ...
                            <v-row class="py-4">
                                ...
                                <v-col cols="12" sm="7" class="mx-auto" style="min-width:236px">
                                    ...
                                    <v-row justify="end" no-gutters>
                                        ...
                                        <ReusableBorderGradientButton @click="next()" class="ml-2" ButtonText="Next"
                                            IconSecondName="mdi-chevron-double-right" />
                                        <!-- <div class="outer-btn ml-2" @click="next()">
                                            <div class="inner-btn">
                                                <p class="mt-n1 ml-2" style="font-size: 14px">Next<v-icon>
        ...
        <v-dialog v-model="confirmDialog" max-width="400" persistent>
            <div class="dark-bg">
                <v-card outlined class="rounded-lg pa-4">
                    ...
                    <v-card-actions>
                        <ReusableBorderGradientButton @click="confirmDialog = false" ButtonText="Cancel" />
                        <v-spacer></v-spacer>
                        <ReusableBorderGradientButton @click="createGallery()" ButtonText="Confirm" />
                    </v-card-actions>
                </v-card>
            </div>
                                            ...
                                            <v-list-item class="px-0">
                                                ...
                                                <v-list-item-action>
                                                    <div v-if="collection.includes(item)"
                                                        @click="$store.commit('nft/deselectNft', item)">
                                                        <v-checkbox color="green" disabled v-model="yes" dark>
                                                        </v-checkbox>
                                                    </div>
                                                    <div v-else @click="$store.commit('nft/selectNft', item)">
                                                        <v-checkbox color="green" v-model="no" disabled dark>
                                                        </v-checkbox>
                                                    </div>
