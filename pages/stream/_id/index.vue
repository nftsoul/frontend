                      ...
                      <v-container>
                        <v-row>
                          <v-col>
                            ...
                            <p class="mb-0">
                              <small
                                >{{ index + 1 }} of {{ stream.nfts.length }}

                                <v-tooltip
                                  top
                                  v-if="favourite.includes(stream._id)"
                                >
          ...
          <v-card dark outlined class="max-width:800">
            <div v-if="comments.length > 0">
              <v-list-item v-for="(item, i) in comments" :key="i">
                <v-list-item-avatar>
                  <v-img
                    v-if="item.user_id.image_link"
                    :src="item.user_id.image_link"
                    max-width="40"
                    max-height="40"
                  ></v-img>
            ...
            <v-card-actions>
              ...
              <v-btn
                text
                x-small
                v-if="comments.length > 4 && totalComments != comments.length"
                @click="getComments()"
                :loading="more"
              >
                See More Comments
            ...
            <v-row no-gutters class="px-5">
              ...
              <v-textarea
                ...
                placeholder="What do you think about the gallery?"
              ></v-textarea>
            </v-row>
