        ...
        <v-container>
            ...
            <v-row justify="center" v-if="collections.length > 0">
                <v-col cols="12" lg="4" md="6" v-for="(item, i) in collections" :key="i" align="center">
                    <div class="outer-btn div1" :class="setMargin(i)">
                        <div class="inner-btn div2" style="flex-direction:column">
                            <v-avatar size="60" class="mt-n16" style="margin: 0 auto 16px">
            ...
            <v-row v-else>
                <v-col cols="12" lg="4" md="6" v-for="(item, i) in 3" :key="i" align="center">
                    <v-skeleton-loader class="mx-auto" :class="setMargin(i)" height="150" max-width="300" type="card">
                    </v-skeleton-loader>
                </v-col>
            </v-row>
        </v-container>
