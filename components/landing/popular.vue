                        ...
                        <client-only>
                            <VueSlickCarousel v-bind="slickSetting">
                                <div v-for="(item, i) in popular" :key="i">
                                    <GalleryCard :galleryId="item._id._id" :title="item._id.gallery_name"
                                        :image="item._id.image" :nfts="item._id.nfts" :creator="item._id.created_by"
                                        :views="item.views" :favourites="item._id.favourites" />
                                </div>
                            </VueSlickCarousel>
                        </client-only>
                    </v-col>
