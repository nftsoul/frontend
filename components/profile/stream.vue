                                    ...
                                    <v-container>
                                        <v-row>
                                            <v-col>
                                                ...
                                                <p class="mb-0">
                                                    <small>{{ index + 1 }} of {{ selected.nfts.length }}

                                                        <v-tooltip top v-if="favourite.includes(selected._id)">
                                        ...
                                        <v-row>
                                            <v-col cols="12" lg="5" md="6">
                                                ...
                                                <div class="pa-4">
                                                    <small class="mt-4 mb-0 text-left" style="color:#c202d3">About this nft</small><br>
                                                    <small class="text--white text-left">{{item.story}}</small>
                                                </div>
...
export default {
    ...
    methods: {
        ...
        getFavourite() {
            axios
                .get(
                    process.env.baseUrl + "/get-favourite-gallery/" +
                    this.walletAddress
                )
                .then((res) => {
        ...
        addToFavourite() {
            ...
            axios
                .post(process.env.baseUrl + "/save-favourite", {
